...
#ifndef MINER_SERIAL_HANDLER_ZTEX_HPP
#define MINER_SERIAL_HANDLER_ZTEX_HPP
...
namespace miner {
    ...
    /**
     * Implements a serial handler for ZTEX based boards.
     */
    class serial_handler_ztex : public serial_handler
    {
            /**
             * Constructor
             * @param owner The serial_port.
             */
            explicit serial_handler_ztex(
...
#endif // MINER_SERIAL_HANDLER_ZTEX_HPP
